...
sed -i 's/\"azure-iot-device\": \".*\",/\"gaudi-iot-device\": \"'"${version}"'\",/g' "${target}"
sed -i 's/\"azure-iot-amqp-base\": \".*\",/\"gaudi-iot-amqp-base\": \"'"${version}"'\",/g' "${target}"
sed -i 's/\"azure-iot-device-amqp\": \".*\",/\"gaudi-iot-device-amqp\": \"'"${version}"'\",/g' "${target}"
